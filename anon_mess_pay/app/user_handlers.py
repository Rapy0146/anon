...
Договор-оферта по ссылке: https://clck.ru/3LTv4P
Политика конфиденциальности по ссылке: https://clck.ru/3LUiNm
<i>Контакты</i>
ИП Крупин Данил Александрович ИНН 422372785525 ОГРН 325547600060562
Расчетный счет 40802810400004949032 БИК 044525974
...
async def but_subscription(call: CallbackQuery, state: FSMContext):
    ...
    p_id, link = create_payment(amount=price, description=f"Подписка на {month} мес.")
    if check_subscription(call.from_user.id):
...
Оплачивая подписку, вы принимаете все условия просписанные в оферте и в политике конфиденциальности.
Ознакомится с офертой: https://clck.ru/3LTv4P
Политика конфиденциальности по ссылке: https://clck.ru/3LUiNm
